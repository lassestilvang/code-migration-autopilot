    ...
    const runStep = async () => {
      try {
        if (state.status === AgentStatus.ANALYZING) {
          ...
          // Slight artificial delay for UX pacing
          setTimeout(() => {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 items-start">
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-dark-800 p-5 rounded-xl border border-dark-700 shadow-xl">
              <h2 className="text-sm font-bold text-gray-400 uppercase tracking-wider mb-4">Configuration</h2>
